...
%% Document Details
\newcommand{\docTitle}{Congestion Control in Multistage Interconnection Networks}
\newcommand{\docAuthor}{Andrew Fecheyr Lippens}
\newcommand{\docDate}{March 3, 2010}
\newcommand{\docSubject}{Arquitectura de redes de altas prestaciones}
