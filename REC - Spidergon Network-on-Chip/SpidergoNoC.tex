...
This allowed a designer of an early SoC to select IP blocks, place them onto the silicon, and connect them together with a standard on-chip bus \cite{furber2005future}.
